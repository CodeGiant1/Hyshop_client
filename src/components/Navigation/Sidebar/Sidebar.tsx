...
const SidebarContext = createContext<SidebarContextType>([false, () => {}]);
        ...
        <div className="border-t flex p-3">
          ...
          >
            <div className="leading-4">
              <h4 className="font-semibold">Dennis Temoye</h4>
...
export const SidebarItem = ({ icon, text, active, alert, url }) => {
  ...
  return (
    ...
    >
      {icon}
      <span
        className={`overflow-hidden transition-all font-normal text-sm ${
          expanded ? 'w-52 ml-3' : 'w-0'
        }`}
      >
        {text}
